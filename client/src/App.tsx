...
//   const [allTodoes, setAllToDoes] = useState<AllToDosType[]>([]);
...
//   const filterAllTodoes = (keyword: string) => {
//     setFilter(keyword);
//     if (keyword === 'all') {
//       setFilteredTodoes(allTodoes);
//     } else if (keyword === 'active') {
//       setFilteredTodoes(allTodoes.filter(el => !el.completed));
...
//                 <button
//                   onClick={() => filterAllTodoes('active')}
...
//                 <button
//                   onClick={() => filterAllTodoes('completed')}
